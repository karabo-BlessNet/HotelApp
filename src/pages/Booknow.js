...
export default class Booknow extends Component {
    ...
    //     </div>);
    //     }
        const {name,capacity,size,price} = room;
        // const [mainImg, ...defaultBcg] = images;
         ...
         const _daysLeft = daysLeft;
         const _price = price * daysLeft;
         
        
        const collectionReF = collection(db, "bookingRoom");
        ...
        const  bookingInfo = ()=>{
            ...
            const bookingRoom = {
                ...
                sizeInSqureFeet:_size,
                checkOutDate:_endDate,
                numberOfDaysToStay:_daysLeft,
                priceToPay:_price,
            ...
            addDoc(collectionReF,bookingRoom).then(()=>{
                ...
                <div className="col-md-10 mx-auto col-12 card shadow-lg border-0 p-4">
                        ...
                        <div className="col-md-6 col-12 my-auto">
                            ...
                            <table className="table">
                                <thead className="thead-light">
                                    ...
                                    <tr>
                                        <th>Size of the room.</th>
                                        <td>{size} squre feet.</td>
                                    </tr>
                    ...
                    <div className="row">
                        <div className="col-md-6 col-12">
                            ...
                            <mark>Checkin time is from 9 am to 12 pm</mark>
                        </div>
                        <div className="col-md-6 col-12">
                    ...
                    <div className="row my-4">
                        ...
                        <div className="col-md-6 col-12 my-auto">
                            <div className="col-md-6 col-12 float-right">
                                <button className="btn btn-block btn-outline-primary" data-toggle="modal" data-target="#thanks" onClick={bookingInfo}>Confirm Booking</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            <Link to="/menu" className="btn btn-dark">Goto Home</Link>
